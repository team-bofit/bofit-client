    ...
    <>
      <Modal>
        ...
        <Modal.ContentContainer>
          <Modal.Content text={'본 서비스는 사용자가 입력한 정보를\n'} />
          <Modal.Content text={'바탕으로 보험 상품을 '} />
          <Modal.HighlightContent text={'참고용'} />
          <Modal.Content text={'으로\n'} />
          <Modal.Content text={'추천하는 도구입니다. 제공되는 정보는\n'} />
          <Modal.HighlightContent
            text={'공식적은 금융 또는 보험 자문이 아니며,\n'}
          />
          <Modal.Content text={'보핏은 이를 통해 중개 수수료 등 경제적\n'} />
          <Modal.Content text={'이익을 얻지 않습니다. 따라서 계약 체결\n'} />
          <Modal.Content text={'전에는 반드시 해당 보험사 또는 공인 \n'} />
          <Modal.Content text={'설계사의 설명을 충분히 확인해주시기 \n'} />
          <Modal.Content text={'바랍니다. '} />
