import {
  CancerDataProps,
  NoehyeolgwanDataProps,
  ShimjangDataProps,
} from '../types/keunbyeong-type';
...
export const cancerData: CancerDataProps = {
  coverageStatus: '강력',
  additional_info:
...
export const noehyeolgwanData: NoehyeolgwanDataProps = {
  coverageStatus: '충분',
  additional_info:
...
export const shimjangData: ShimjangDataProps = {
  coverageStatus: '강력',
  additional_info:
